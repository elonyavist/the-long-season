...
```bash
pnpm cli ten-season-report --seed-prefix=phase78-contract-finance-benchmark-v3 --worlds=1 --seasons=50 --report-output=reports/phase78-contract-finance-benchmark-v3-transfer-batch.md
```
