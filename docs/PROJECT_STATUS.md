...
- Step: `docs/steps/13-localization-foundation/01-phase-12-output-review.md`
- Status: Not started
- Last verification: Phase 13 documentation-only scope correction; no source checks required.
- Next action: Review the current Phases 00-12 CLI/source user-facing text, including match events and non-formation reports, and identify the message groups that must move behind localization.
...
| `docs/steps/13-localization-foundation/01-phase-12-output-review.md` | Not started | Future Phase 13 step. | Review current Phases 00-12 CLI/source user-facing text, including events, reports, stats, tactic/lineup/condition output, formation-fit labels, and user-facing errors. | Pending |
| `docs/steps/13-localization-foundation/02-language-contract-and-fallback.md` | Planned | Future Phase 13 step. | Define supported languages, deterministic English fallback, message-key namespaces, and interpolation rules. | Pending |
| `docs/steps/13-localization-foundation/03-label-catalog-it-en.md` | Planned | Future Phase 13 step. | Add the first complete English and Italian message catalog for the current CLI-visible game surface. | Pending |
| `docs/steps/13-localization-foundation/04-cli-language-option.md` | Planned | Future Phase 13 step. | Expose CLI `--lang` and migrate current CLI presentation output to localized messages. | Pending |
| `docs/steps/13-localization-foundation/05-five-language-label-completion.md` | Planned | Future Phase 13 step. | Complete German, Spanish, and French labels for the current user-facing catalog. | Pending |
| `docs/steps/13-localization-foundation/06-hardcoded-presentation-text-enforcement.md` | Planned | Future Phase 13 step. | Add enforcement so new presentation code cannot introduce hardcoded user-facing strings without localization keys. | Pending |
| `docs/steps/13-localization-foundation/07-project-policy-localization-alignment.md` | Planned | Future Phase 13 step. | Align `requirements.md` and `docs/PROJECT_RULES.md` so labels useful to CLI or UI cannot be hardcoded in produced code. | Pending |
