...
Report how well a squad fits a selected formation and what tactical-market needs it creates.

## Why we implement it this way

This is the core of the user's request: the user should feel that changing formation changes what the squad needs.
...
- A team with one striker may not fit `3-5-2` without buying another forward.
...
- Output should include:
  ...
  - surplus broad groups;
  - market-need hints as data, not prose.
- Market-need hints should be narrow and future-facing, for example:
  - `need:left_full_back`
...
- Reports expose missing roles and surplus groups as structured deterministic data.
- The report supports future market planning without implementing the market.
