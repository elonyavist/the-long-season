...
- Potenziale: valutazione pubblica globale a stelle e, quando esisterà lo scouting, range affinabile; mai un numero fisso esatto in UI. L'atterraggio nel range lo decide lo sviluppo reale: minutaggio, allenamento, strutture, personalità.
- Valutazione pubblica: livello corrente e potenziale usano la stessa scala globale, indipendente dal club osservante, da 1 a 6 stelle a passi di mezza stella. `5,5` mostra cinque stelle oro più mezza sesta stella arancione scuro; `6` mostra la sesta piena. La stessa persona deve avere lo stesso rating in Rosa, Mercato, schieramento e dettaglio.
...
- Generazione giocatori: le abilità devono essere coerenti con divisione, forza del club, ruolo, età, abilità corrente e potenziale. Per i senior pronti per la prima squadra, la terza divisione è normalmente da 1 a 3 stelle con sporadici 3,5; la seconda da 2 a 3,5 con sporadici 4; la prima da 3 a 5,5 con rarissimi 6. Giovani e riserve possono stare sotto queste fasce. Il potenziale è globale e separato dalla forza attuale: una rarissima promessa di categoria inferiore può avere potenziale superiore senza essere già pronta per la prima divisione. La terza divisione deve avere un livello simile alla Serie C italiana: pochi giocatori devono poter restare utili dopo 6-7 stagioni di scalata, di solito come riserve o eccezioni narrative. Ogni rosa può avere giovani interessanti, ma solo una minoranza deve diventare forte per la prima divisione. Le "mosche bianche" di categoria inferiore sono ammesse, ma rare e budgettate a livello di mondo/lega; i campioni correnti devono essere collocati in club e slot di prima squadra credibili, non parcheggiati in riserva da un allocatore. Il mondo iniziale contiene 1–2 sei-stelle correnti e 2–4 potenziali; questi numeri non si riapplicano a ogni intake. Ogni intake mondiale annuale genera 0–1 nuovo potenziale sei-stelle e ogni coorte deterministica di dieci stagioni ne genera 2–4. Al decimo anno i cap anti-inflazione sono 4 sei-stelle correnti attivi e 8 potenziali, con al massimo un potenziale sei-stelle sotto la prima divisione. Gli attributi fuori ruolo devono essere cappati: un difensore con Finalizzazione alta, un attaccante con Contrasto alto o un portiere con profilo da giocatore di movimento devono essere eccezioni esplicite, non rumore casuale.
...
- Valore di mercato pubblico, prezzo richiesto dal venditore e cifra finale sono tre fatti distinti. Il valore pubblico è globale e deterministico, guidato soprattutto da qualità, potenziale, età, ruolo e contesto di mercato; non cambia col club osservante né con la forma settimanale. Contratto, importanza in rosa, necessità/pressione del venditore e trattativa agiscono soprattutto su richiesta e cifra finale.
- Uno svincolato conserva un valore di mercato pubblico ma ha cartellino esattamente zero; restano dovuti solo i costi contrattuali supportati. La coda alta è compressa progressivamente e il massimo di game design è `€150m`, raggiungibile solo da un rarissimo sei-stelle di 25 anni o meno, senza ridimensionare proporzionalmente tutte le categorie.
