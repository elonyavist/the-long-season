...
import { phase80AInitialWorldObservations } from "../ten-season-report/report-data.ts";

import {
  createHardCapReachabilityProbeReport,
...
test("a world that fails reconciliation withholds the outcome instead of reporting a hit", () => {
  ...
  const report = createHardCapReachabilityProbeReport([
    {
      seedPrefix: "phase81a-hardcap-a",
      worldSeed: "phase81a-hardcap-a-world-00001",
      rows: [hit],
