...
import {
  ...
  type SingleWorldLongRunReport,
} from "../ten-season-report/report-data.ts";

type CalibrationVersionBundle = SingleWorldLongRunReport["league"]["calibrationVersions"];
...
export interface HardCapReachabilityProbeReport {
 ...
 */
export function createHardCapReachabilityProbeReport(
 ...
 */
export async function runHardCapReachabilityProbe(
  ...
  return createHardCapReachabilityProbeReport(
    results
