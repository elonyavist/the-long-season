...
import type { TacticalAgencyCounterfactualResult } from "./tactical-agency-world.ts";
...
export interface CheckpointA21Facts {
  readonly setName: string;
...
export interface CheckpointA2Facts {
  ...
  readonly lowBlockAttributionFacts: readonly CheckpointA21Facts[];
