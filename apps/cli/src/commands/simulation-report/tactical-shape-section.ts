...
export interface CreateTacticalShapeSectionInput {
...
export interface TacticalShapeSectionFacts {
 ...
 */
export function createTacticalShapeSectionFacts(
  input: CreateTacticalShapeSectionInput = {},
): TacticalShapeSectionFacts {
