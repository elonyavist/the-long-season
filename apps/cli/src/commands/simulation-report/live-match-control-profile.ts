...
/** Input accepted by the locked content-aware profile producer. */
export interface CreateLiveMatchControlProfileInput {
 ...
 */
export function createLiveMatchControlProfileFacts(
  input: CreateLiveMatchControlProfileInput = {},
