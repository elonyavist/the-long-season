...
import {
  ...
  createLongRunGateFactsFromWorlds,
...
export interface CreateResumableLongRunGateFactsInput {
...
export interface CreateResumablePlayerDevelopmentCohortFactsInput {
  readonly seedPrefix: string;
  readonly worldCount: number;
 ...
 */
export async function createResumableLongRunGateFacts(
  input: CreateResumableLongRunGateFactsInput,
): Promise<LongRunGateFacts> {
 ...
 */
export async function createResumablePlayerDevelopmentCohortFacts(
  input: CreateResumablePlayerDevelopmentCohortFactsInput,
): Promise<PlayerDevelopmentCohortFacts> {
...
async function runMissingWorlds(context: {
  readonly input: CreateResumableLongRunGateFactsInput;
  readonly shardCount: number;
  readonly workerCount: number;
