...
export const SIMULATION_REPORT_PROFILES = {
  ...
  "phase81a-stationary-age-succession-l6-40-7x10": {
    id: "phase81a-stationary-age-succession-l6-40-7x10",
    titleKey: "simulationReport.profile.phase81aStationaryAgeSuccessionL6_40.title",
    descriptionKey: "simulationReport.profile.phase81aStationaryAgeSuccessionL6_40.description",
    measurementRequest: {
      mode: "profile",
  ...
  "phase81a-progressive-current16-l6-42a-cached": {
    id: "phase81a-progressive-current16-l6-42a-cached",
    titleKey: "simulationReport.profile.phase81aProgressiveCurrent16L6_42A.title",
    descriptionKey: "simulationReport.profile.phase81aProgressiveCurrent16L6_42A.description",
    measurementRequest: {
      mode: "profile",
...
>>> = {
  ...
  "phase81a-progressive-current16-l6-42a-cached": {
    profileId: "phase81a-stationary-age-succession-l6-40-7x10",
    directory:
      "saves/long-run-checkpoints/phase81a-stationary-age-succession-l6-40-7x10-facts-v1",
  },
};
